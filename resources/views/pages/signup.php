...
<body>
    ...
    <form class="flex flex-col justify-center items-center mb-10" id="signup" action="" method="post">
        <div class="w-11/12 md:w-3/4 lg:w-1/2 bg-gradient-to-br from-blue-900 to-gray-900 mt-10 rounded-md p-4">
            <h2
                ...
                Sign Up</h2>
            <p class="text-xl text-[#FF8A71] text-center my-3 mt-5">Let's get started and chat with GPT-3.
            </p>
            <div class="mt-16 mb-5 w-11/12 mx-auto">
                ...
                <p class="text-red-700 text-md font-medium"><?php echo $email_err ?></p>
            </div>
            ...
            <div class="my-10 w-11/12 mx-auto">
                ...
                <p class="text-red-700 text-md font-medium"><?php echo $password_err ?></p>
            </div>
            <div class="w-11/12 mx-auto">
                <p class="text-md text-gray-300">Already have an account ? <a href="/openai/sign-in" class="text-blue-500 underline decoration-dotted hover:text-blue-400">Sign in and get started!</a></p>
            </div>
            <div class="mt-12 w-11/12 mx-auto">
                <button type="submit"
                    class="text-white w-full bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-md px-5 py-2.5 text-center mr-2 mb-2 transition-all hover:rounded-full">Sign Up</button>
            </div>
